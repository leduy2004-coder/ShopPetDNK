...
namespace ShopThuCungDNK.GUI
{
    public partial class frmNVThuCung : Form
    {
        ...
        public void HienThiThuCung()
        {
            ...
            dgvThuCung.Columns.Add(new DataGridViewTextBoxColumn { HeaderText = "Giống", DataPropertyName = "giong", Width = 150 });
            dgvThuCung.Columns.Add(new DataGridViewTextBoxColumn { HeaderText = "Tình Trạng", DataPropertyName = "tinhTrang", Width = 120 });
            dgvThuCung.Columns.Add(new DataGridViewTextBoxColumn { HeaderText = "Nhà Cung Cấp", DataPropertyName = "nhaCC", Width = 150 });
